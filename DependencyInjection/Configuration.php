                        ...
                        ->children()
                            ...
                            ->arrayNode(self::TYPE_EMAIL_CONFIRMATION)
                                ...
                                ->children()
                                    ...
                                    ->scalarNode(self::TEMPLATE)->defaultValue('SuluCommunityBundle:EmailConfirmation:email-success.html.twig')->end()
                                    ->arrayNode(self::EMAIL)
                                        ->addDefaultsIfNotSet()
                                        ->children()
                                            ->scalarNode(self::EMAIL_SUBJECT)->defaultValue('E-Mail change')->end()
                                            ->scalarNode(self::EMAIL_ADMIN_TEMPLATE)->defaultValue(null)->end()
                                            ->scalarNode(self::EMAIL_USER_TEMPLATE)->defaultValue('SuluCommunityBundle:EmailConfirmation:email-email.html.twig')->end()
                                        ->end()
                                    ->end()
                                ->end()
                            ->end()
